...
function SignUpPages() {
  ...
  return (
    <Box w='100%' mt='4rem'>
            ...
            <Box>
              <Center>
                <Box w='100%' className='background' mt='1rem'>
                  <Center>
                    {' '}
                    <Box className='Google_Button'>
                      <a href='http://localhost:8080/user/auth/google'>
                        {' '}
                        <Center w='100%'>
                          {' '}
                          <Button
      ...
      <Box>
        ...
        >
          <Box className='card' id='a'>
            ...
            design.” — Jennifer H. (Source:{' '}
            <span className='Link'>TrustRadius</span>)
          </Box>
          ...
          <Box className='card' id='c'>
            ...
            as needed.” — Dan S. (Source: <span className='Link'>Capterra</span>
            )
          </Box>
          <Box className='card' id='d'>
            ...
            kind of software” — Ivan M. (Source:{' '}
            <span className='Link'>G2Crowd</span>)
          </Box>
          <Box className='card' id='e'>
          ...
          <Box className='card' id='f'>
            ...
            are already on Asana, a simple click does the job.” — Dimitris
            R.(Source: <span className='Link'>Capterra</span>)
          </Box>
          <Box className='card' id='g'>
            ...
            can see who is working right now and a summary each day”. — Doug H.
            (Source: <span className='Link'>G2Crowd</span>){' '}
          </Box>
          <Box className='card' id='h'>
            ...
            invoice clients and track projects.” — Jennifer D. (Source:{' '}
            <span className='Link'>TrustRadius</span>)
          </Box>
        </SimpleGrid>
      </Box>
      <Center>
        {' '}
        <Button mt='2rem' colorScheme='green' variant='outline'>
          Read More
        </Button>
      </Center>
    </Box>
